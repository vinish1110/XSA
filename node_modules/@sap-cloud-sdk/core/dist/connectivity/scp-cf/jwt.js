...
function validateJwtHeaderForVerification(header, uaaDomain) {
    ...
    if (!uaaDomain || !jkuDomain || !jkuDomain.endsWith(uaaDomain)) {
        throw new Error("The domains of the XSUAA and verification URL do not match. The XSUAA domain is '" + uaaDomain + "' and the jku field provided in the JWT is '" + jkuDomain + "'.");
    }
}
/*
...
function getVerificationKey(xsuaaCredentials, header) {
    return verification_keys_1.fetchVerificationKeys(xsuaaCredentials, header.jku).then(function (verificationKeys) {
