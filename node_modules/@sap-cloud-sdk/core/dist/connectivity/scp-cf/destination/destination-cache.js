...
function getDestinationCacheKeyStrict(decodedJwt, destinationName, isolationStrategy) {
    ...
    var tenant = tenant_1.tenantId(decodedJwt);
    var user = user_1.userId(decodedJwt);
...
function cacheRetrievedDestination(decodedJwt, destination, isolation, cache) {
    ...
    var expiresIn = (_a = util_1.first(destination.authTokens || [])) === null || _a === void 0 ? void 0 : _a.expiresIn;
    var expirationTime = expiresIn
        ? moment_1.default().add(expiresIn, 'second').unix() * 1000
        : undefined;
