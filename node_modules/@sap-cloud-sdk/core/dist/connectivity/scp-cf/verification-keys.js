...
clientSecret) {
    ...
    if (typeof xsuaaUriOrCredentials !== 'string') {
        if (!clientIdOrJku) {
            ...
            return executeFetchVerificationKeys(xsuaaUriOrCredentials.url + "/token_keys");
        }
...
function executeFetchVerificationKeys(url) {
    ...
    return axios_1.default
        ...
        throw new util_1.ErrorWithCause("Failed to fetch verification keys from XSUAA service instance \"" + url + "\".", error);
    });
}
